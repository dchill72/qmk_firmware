 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |      |      |      |      |      | LEFT | DOWN | RGHT |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      | Next | Vol- | Vol+ | Play |      |
 * `------------------------------------------------'      `------------------------------------------------'
 */
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     PLUS, F1 , F2 , F3 , F4 , F5 , F6 ,     UNDS,PLUS,LCBR,RCBR,    , UP ,    ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         , F7 , F8 , F9 ,F10 ,F11 ,F12 ,         ,    ,    ,    ,LEFT,DOWN,RGHT,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
 ...
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |      |  F7  |  F8  |  F9  |  F10 |  F11 |  F12 |      |ISO # |ISO / |      |      | LEFT | DOWN | RGHT |
 * |------+------+------+------+------+------+------|      |------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      | Next | Vol- | Vol+ | Play |      |
 * `------------------------------------------------'      `------------------------------------------------'
 */
  [_RAISE] = LAYOUT_kc(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
     TILD, F1 , F2 , F3 ,    ,    ,    ,         ,    ,    ,    ,PSLS,PAST,MINS,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     UNDS, F4 , F5 , F6 ,    ,    ,    ,         ,    ,    , P7 , P8 , P9 ,PPLS,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     PLUS, F7 , F8 , F9 ,    ,    ,    ,         ,    ,    , P4 , P5 ,P6 , PEQL,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,F10 ,F11 ,F12 ,    ,    ,    ,         ,    ,    , P1 , P2 , P3 ,PENT,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,    ,    ,    ,    ,    ,    ,         ,    ,    , P0 , P0 ,PDOT,BSPC
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
