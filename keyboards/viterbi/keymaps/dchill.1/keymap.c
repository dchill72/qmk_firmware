...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     END, LSFT, A  , S  , D  , F  , G  ,      H  , J  , K  , L  ,SCLN,QUOT,ENT ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     PGUP,LSFT, Z  , X  , C  , V  , B  ,      N  , M  ,COMM,DOT ,SLSH,BSLS,INS,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     PGDN,LCTL,LALT,LGUI,LOWR,SPC ,SPC,      SPC, SPC, RASE,LEFT,DOWN, UP ,RGHT
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
  ...
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     PLUS,    , F1 , F2 , F3 , F4 , F5 ,      F6 ,UNDS,PLUS,LCBR,RCBR,    , ENT,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         ,    , F7 , F8 , F9 ,F10 ,F11 ,     F12 ,    ,    ,    ,    ,    , END,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     QWRT,AJST,    ,    ,LOWR,SPC ,SPC,      SPC, SPC, RASE,VOLD,VOLU,MPLY,MUTE
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),

  [_RAISE] = LAYOUT_kc(
  //,----+----+----+----+----+----+----.    ,----+----+----+----+----+----+----.
         ,TILD, F1 , F2 , F3 , F4 , F5 ,      F6 , F7 , F8 , F9 ,F10 ,DEL ,INS ,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     UNDS,    , 1  , 2  , 3  , 4  , 5  ,      6  , 7  , 8  , 9  , 0  ,LCBR,RCBR,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     PLUS, F1 , F2 , F3 , F4 , F5 , F6 ,     MINS, EQL ,LBRC,RBRC,    ,   , ENT,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
         , F7 , F8 , F9 ,F10 ,F11, F12 ,     NUHS, NUBS,    ,    ,    ,   , END,
  //|----+----+----+----+----+----+----|    |----+----+----+----+----+----+----|
     QWRT,AJST,    ,    ,LOWR,SPC ,SPC,      SPC, SPC, RASE,VOLD,VOLU,MPLY,MUTE
  //`----+----+----+----+----+----+----'    `----+----+----+----+----+----+----'
  ),
